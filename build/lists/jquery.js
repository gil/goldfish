Goldfish.addList({
	...
	"groups": [
		...
		{
			"name": "Attributes, Class Attribute, CSS",
			"entries": [
				{
					"name": ".addClass()",
		...
		{
			"name": "Basic Filter, jQuery Extensions",
			"entries": [
				{
		...
		{
			"name": "Attribute, jQuery Extensions",
			"entries": [
				{
		...
		{
			"name": "Internals, Properties of jQuery Object Instances",
			"entries": [
				{
					"name": ".context",
		...
		{
			"name": "Collection Manipulation, Traversing",
			"entries": [
				{
					"name": ".each()",
		...
		},
		{
			...
			"entries": [
				...
				},
				{
					...
					"description": "Prevents other event handlers from being called."
				},
				{
		...
		{
			"name": "Keyboard Events, Mouse Events",
			"entries": [
				{
					"name": ".focusin()",
		...
		{
			"name": "Custom, Properties of the Global jQuery Object",
			"entries": [
				{
		...
		{
			"name": "Content Filter, jQuery Extensions",
			"entries": [
				{
					"name": ":has() Selector",
		...
		{
			"name": "CSS, Dimensions, Style Properties",
			"entries": [
				{
					"name": ".height()",
		...
		{
			"name": "jQuery Extensions, Visibility Filter",
			"entries": [
				{
		...
		{
			"name": "Attributes, DOM Insertion, Inside",
			"entries": [
				{
					"name": ".html()",
		...
		{
			"name": "Filtering, Miscellaneous Traversing",
			"entries": [
				{
					"name": ".not()",
		...
		{
			"name": "CSS, Offset, Style Properties",
			"entries": [
				{
					"name": ".offset()",
		...
		{
			"name": "Collection Manipulation, Forms, Helper Functions",
			"entries": [
				{
					"name": "jQuery.param()",
		...
		{
			"name": "Event Handler Attachment, Utilities",
			"entries": [
				{
					"name": "jQuery.proxy()",
		...
		{
			"name": "Properties of the Global jQuery Object, Utilities",
			"entries": [
				{
					"name": "jQuery.support",
		...
		{
			"name": "DOM Insertion, Around, DOM Removal",
			"entries": [
				{
					"name": ".unwrap()",
		...
		{
			"name": "Attributes, Forms, General Attributes",
			"entries": [
				{
					"name": ".val()",
